...
(
    ...
    workspaceVariable_entityID varchar
(
    128
),
    primary key
...
(
    ...
    widgetTabEntity_entityID varchar
(
    128
),
    primary key
(
    ...
    foreign key
(
    widgetTabEntity_entityID
) references widget_tabs
    );
...
(
    ...
    locked boolean not null,
    workspaceGroup_entityID varchar
(
    128
),
    primary key

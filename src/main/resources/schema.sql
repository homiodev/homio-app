...
(
    ...
    java_script_parameters varchar
(
    65535
),
    json_data varchar
...
(
    ...
    workspace_variable_entityid varchar
(
    128
),
    primary key
(
    ...
    foreign key
(
    workspace_variable_entityid
) references workspace_variable
    );
...
(
    ...
    widget_tab_entity_entityid varchar
(
    128
),
    primary key
(
    ...
    foreign key
(
    widget_tab_entity_entityid
) references widget_tab_entity
    );
...
(
    ...
    widget_entity_entityid varchar
(
    128
),
    primary key
(
    ...
    foreign key
(
    widget_entity_entityid
) references widget_entity
    );
...
(
    ...
    locked boolean not null,
    workspace_group_entityid varchar
(
    128
),
    primary key

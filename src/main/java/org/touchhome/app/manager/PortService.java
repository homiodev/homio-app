...
/**
 * Port manager scan all setting bundles to match type as SerialPort and listen if ports available or not, fire notifications and set header notifications
 */
@Log4j2
@Component
...
public class PortService implements BeanPostConstruct {
  ...
  private final Map<Class<? extends SettingPlugin<SerialPort>>, Pair<String, Boolean>> portListeners = new HashMap<>();

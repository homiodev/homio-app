package org.touchhome.app.utils.color;
...
public class ColorThief {
   ...
   *
   * @param sourceImage the source image
   * @param quality     1 is the highest quality settings. 10 is the default. There is a trade-off between quality and speed. The bigger the number, the faster a color will be
   *                    returned but the greater the likelihood that it will not be the visually most dominant color.
   ...
   * @param sourceImage the source image
   * @param colorCount  the size of the palette; the number of colors returned
   * @param quality     1 is the highest quality settings. 10 is the default. There is a trade-off between quality and speed. The bigger the number, the faster the palette

...
public interface SshHardwareRepository {
    ...
    @HardwareQuery(name = "Install tmate", printOutput = true,
            value = "mv ${rootDir}/tmate-2.4.0-static-linux-:armv/tmate ${rootDir}/ssh/tmate && rm -rf ${rootDir}/tmate-2.4.0-static-linux-:armv && chmod +x ${rootDir}/ssh/tmate")
    void installTmate(@HQueryParam("armv") String armv);

    @HardwareQuery(name = "Get tmate version", value = "${rootDir}/ssh/tmate -V", ignoreOnError = true, cacheValid = 3600)

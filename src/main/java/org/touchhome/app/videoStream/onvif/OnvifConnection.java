...
import org.touchhome.bundle.api.measure.ObjectType;
        ...
        switch (topic) {
            case "RuleEngine/CellMotionDetector/Motion":
                if (dataValue.equals("true")) {
                    onvifCameraHandler.motionDetected(CHANNEL_CELL_MOTION_ALARM);
                } else if (dataValue.equals("false")) {
                    onvifCameraHandler.noMotionDetected(CHANNEL_CELL_MOTION_ALARM);
                }
                break;

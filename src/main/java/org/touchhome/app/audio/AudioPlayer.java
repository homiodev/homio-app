package org.touchhome.app.audio;
...
public class AudioPlayer extends Thread {
  ...
  protected @Nullable AudioFormat convertAudioFormat(org.touchhome.bundle.api.audio.AudioFormat audioFormat) {
    String codec = audioFormat.getCodec();
    AudioFormat.Encoding encoding = new AudioFormat.Encoding(codec);
    if (org.touchhome.bundle.api.audio.AudioFormat.CODEC_PCM_SIGNED.equals(codec)) {
      encoding = AudioFormat.Encoding.PCM_SIGNED;
    } else if (org.touchhome.bundle.api.audio.AudioFormat.CODEC_PCM_ULAW.equals(codec)) {
      encoding = AudioFormat.Encoding.ULAW;
    } else if (org.touchhome.bundle.api.audio.AudioFormat.CODEC_PCM_ALAW.equals(codec)) {

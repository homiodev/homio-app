...
/**
 * This object lets us persuade jackson into serializing JSOG structures. It is the id generated, and a special serializer knows how to convert it to an @id or @ref as
 * appropriate.
 *
...
public class JSOGRef {
  ...
  /**
   * A flag we use to determine if this ref has already been serialized. Because jackson calls the same code for serializing both ids and refs, we simply assume the key use is an
   * id and all subsequent uses are refs.
   */

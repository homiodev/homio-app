...
public class Scratch3ImageEditBlocks extends Scratch3ExtensionBlocks {
  ...
  public Scratch3ImageEditBlocks(EntityContext entityContext) {
    ...
    // Blocks
    blockReporter(11, "rotate", "Rotate at [DEGREE]° of image [IMAGE]", this::rotateImageCommand, block -> {
      block.addArgument("IMAGE", "");
      block.addArgument("DEGREE", 90);
    });

    blockReporter(22, "scale", "Scale at SX[SX]XY[SY] of image [IMAGE]", this::scaleImageCommand, block -> {
      block.addArgument("IMAGE", "");
      block.addArgument("SX", 0.5f);
      block.addArgument("SY", 0.5f);
    });

    blockReporter(33, "resize", "Resize at W[W]H[H] of image [IMAGE]", this::resizeImageCommand, block -> {
      block.addArgument("IMAGE", "");
      block.addArgument("W", 640);
      block.addArgument("H", 480);
    });

    blockReporter(44, "translate", "Translate at X[X]Y[Y] of image [IMAGE]", this::translateImageCommand, block -> {
      block.addArgument("IMAGE", "");
    ...
    blockReporter(55, "text", "Set text [TEXT] with color [COLOR] at pos [POSITION] of image [IMAGE]",
        this::setTextImageCommand, block -> {
          block.addArgument("IMAGE", "");
    ...
    blockReporter(66, "flip", "Flip image [IMAGE] | Vertically: [VALUE]", this::flipImageCommand, block -> {
      block.addArgument("IMAGE", "");
      block.addArgument(VALUE, false);
    });

    blockReporter(77, "crop", "Crop at X[X]Y[Y]W[W]H[H] of image [IMAGE]", this::cropImageCommand, block -> {
      block.addArgument("IMAGE", "");
    ...
    blockReporter(88, "overlay", "Overlay image [IMAGE] with [IMAGE2](X[X]Y[Y]W[W]H[H])",
        this::overlayImageCommand, block -> {
          block.addArgument("IMAGE", "");
    ...
    blockReporter(99, "brightness", "Set brightness [VALUE] of image [IMAGE])",
        this::brightnessImageCommand, block -> {
          block.addArgument("IMAGE", "");

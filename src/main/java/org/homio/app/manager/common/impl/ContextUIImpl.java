...
public class ContextUIImpl implements ContextUI {
    ...
    private final @Getter
    @Accessors(fluent = true) ContextUIToastrImpl toastr =
            new ContextUIToastrImpl();
    private final @Getter
    @Accessors(fluent = true) ContextUINotificationImpl notification =
            new ContextUINotificationImpl();
    private final @Getter
    @Accessors(fluent = true) ContextUIConsoleImpl console =
            new ContextUIConsoleImpl();
    private final @Getter
    @Accessors(fluent = true) ContextUIDialogImpl dialog =
            new ContextUIDialogImpl();
    private final @Getter
    @Accessors(fluent = true) ContextUIProgressImpl progress =
            new ContextUIProgressImpl();
    private final @Getter
    @Accessors(fluent = true) ContextUIMediaImpl media =
            new ContextUIMediaImpl();

    private final @Getter
    @NotNull Map<String, Map<String, ItemsContextMenuAction>>
    ...
    public void addHeaderMenuButton(
            String name, Icon icon, @NotNull String page) {

...
public class ChromecastEntity extends DeviceBaseEntity
    implements BaseStreamEntity,
  ...
  public @NotNull String getDeviceFullName() {
    return "%s(%s) [${%s}]"
        .formatted(
            getTitle(), getIeeeAddress(), defaultIfEmpty(getPlace(), "W.ERROR.PLACE_NOT_SET"));
  }

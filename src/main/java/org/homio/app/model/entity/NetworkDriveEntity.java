...
@Entity
@UISidebarChildren(icon = "fas fa-network-wired", color = "#1AA36A")
public class NetworkDriveEntity extends StorageEntity implements BaseFileSystemEntity<NetworkDriveFileSystem>,
  ...
  @Override
  public @NotNull Class<NetworkDriveService> getEntityServiceItemClass() {
    return NetworkDriveService.class;
  }

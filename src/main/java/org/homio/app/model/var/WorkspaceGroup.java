...
public class WorkspaceGroup extends BaseEntity
    ...
    public void assembleActions(UIInputBuilder uiInputBuilder) {
        uiInputBuilder.addOpenDialogSelectableButton("ADD_GROUP", new Icon("fas fa-layer-group"),
                ...
                .editDialog(dialogBuilder -> addCommonFields(dialogBuilder, "field.groupName", builder -> {
                }));
        ...
        if (this.getEntityID().equals("group_broadcast")) {
            uiInputBuilder.addOpenDialogSelectableButton("ADD_BROADCAST_VARIABLE", new Icon("fas fa-rss"),
                            (context, params) -> createVar(context, params, ContextVar.VariableType.Broadcast, true))
                    .editDialog(dialogBuilder ->
                            addCommonFields(dialogBuilder, "field.broadcastName", builder ->
    ...
    public @NotNull ActionResponseModel createVar(Context context, JSONObject params, ContextVar.VariableType variableType, boolean readOnly) {
        ...
        if (context.var().exists(name)) {
            return ActionResponseModel.showError("W.ERROR.EXISTS_VARIABLE");
        }

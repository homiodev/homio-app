...
import org.homio.app.extloader.jcl.AbstractClassLoader;
...
import org.homio.app.extloader.jcl.exception.JclContextException;
import org.homio.app.extloader.jcl.utils.PathResolver;
...
public class XmlContextLoader implements JclContextLoader {
    ...
    private static final String JCL_CONTEXT_SCHEMA = "org/homio/app/extloader/jcl/context/jcl-context.xsd";

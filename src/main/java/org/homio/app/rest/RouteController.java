...
public class RouteController {
    ...
    private void addRouteFromUISideBarMenu(List<RouteDTO> routes, Class<?> aClass) {
        ...
        route.sort = Stream.of(entityRoute.sort()).filter(s -> !s.isEmpty()).collect(Collectors.toList());
        route.filter = Stream.of(entityRoute.filter()).filter(s -> !s.isEmpty()).collect(Collectors.toList());
        routes.add(route);
    }

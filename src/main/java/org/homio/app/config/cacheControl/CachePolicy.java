...
public enum CachePolicy {
    ...
    /**
     * Forces caches to submit the request to the origin server for validation before releasing a cached copy.  Useful to assure that authentication is
    ...
    /**
     * Tells caches that they must obey any freshness information you give them. HTTP allows caches to serve stale representations under special conditions; by
     * specifying this policy, you're telling the cache that you want it to strictly follow your rules.
     */

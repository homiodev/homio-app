...
/**
 * For RTP formats using a dynamic payload type number, the dynamic payload type number is given as the format and an additional "rtpmap" attribute specifies the format and
 * parameters. a=rtpmap:(payload type) (encoding name)/(clock rate) [/&lt;encoding parameters&gt;]
 */

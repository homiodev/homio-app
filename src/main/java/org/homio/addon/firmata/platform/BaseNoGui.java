...
import static org.homio.addon.firmata.platform.I18n.tr;
import static org.homio.addon.firmata.platform.helpers.filefilters.OnlyDirs.ONLY_DIRS;
...
import org.homio.addon.firmata.arduino.Constants;
...
import org.homio.addon.firmata.arduino.contributions.libraries.LibrariesIndexer;
import org.homio.addon.firmata.arduino.contributions.packages.ContributedPlatform;
import org.homio.addon.firmata.arduino.contributions.packages.ContributedTool;
import org.homio.addon.firmata.arduino.contributions.packages.ContributionsIndexer;
...
import org.homio.addon.firmata.arduino.packages.DiscoveryManager;
import org.homio.addon.firmata.platform.debug.LegacyTargetPackage;
import org.homio.addon.firmata.platform.debug.LegacyTargetPlatform;
...
import org.homio.addon.firmata.platform.debug.TargetPlatformException;
import org.homio.addon.firmata.platform.helpers.BasicUserNotifier;
import org.homio.addon.firmata.platform.helpers.CommandlineParser;
import org.homio.addon.firmata.platform.helpers.FileUtils;
import org.homio.addon.firmata.platform.helpers.OSUtils;
import org.homio.addon.firmata.platform.helpers.PreferencesMap;
import org.homio.addon.firmata.platform.helpers.UserNotifier;
import org.homio.addon.firmata.platform.helpers.filefilters.OnlyDirs;
import org.homio.addon.firmata.platform.helpers.filefilters.OnlyFilesWithExtension;
import org.homio.addon.firmata.platform.legacy.PApplet;
import org.homio.addon.firmata.platform.packages.LibraryList;
import org.homio.addon.firmata.platform.packages.UserLibrary;
import org.homio.addon.firmata.platform.packages.UserLibraryFolder;
import org.homio.addon.firmata.platform.packages.UserLibraryFolder.Location;
...
public class BaseNoGui {
  ...
  static private File examplesFolder = getContentFile("examples");
  static private File toolsFolder = getContentFile("tools");
  ...
  static public void initPlatform() {
    try {
      Class<?> platformClass = Class.forName("org.homio.addon.firmata.platform.Platform");
      if (OSUtils.isMacOS()) {
        platformClass = Class.forName("org.homio.addon.firmata.platform.macosx.Platform");
      } else if (OSUtils.isWindows()) {
        platformClass = Class.forName("org.homio.addon.firmata.platform.windows.Platform");
      } else if (OSUtils.isLinux()) {
        platformClass = Class.forName("org.homio.addon.firmata.platform.linux.Platform");
      }
  ...
  static public void saveFile(String str, File file) throws IOException {
    Files.createDirectories(file.toPath().getParent()); // ensure folder exists

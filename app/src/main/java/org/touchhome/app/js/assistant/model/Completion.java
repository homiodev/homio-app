...
public class Completion implements Comparable<Completion> {
     ...
     * that the editor decides which item that is. The rule is that the *key* item of those
    ...
    IRange range;
    /**
     * An optional set of characters that when pressed while this completion is active will accept it key and

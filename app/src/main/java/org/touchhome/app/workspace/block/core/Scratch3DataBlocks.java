...
public class Scratch3DataBlocks extends Scratch3ExtensionBlocks {
    ...
    public Scratch3DataBlocks(EntityContext entityContext, WorkspaceBackupRepository workspaceBackupRepository, BroadcastLockManager broadcastLockManager) {
        ...
        // Blocks
        this.isBoolVariableTrueBlock = Scratch3Block.ofEvaluate("bool_variables", BlockType.reporter, this::isBoolVariableTrueHandler);
        ...
        this.lastBackupBlock = Scratch3Block.ofEvaluate("last_backup_value", BlockType.reporter, this::lastBackupValueEvaluate);
        this.backupBlock = Scratch3Block.ofHandler("addtobackup", BlockType.command, this::backupHandler);

        this.groupVariableBlock = Scratch3Block.ofEvaluate("group_variable", BlockType.reporter, this::groupVariableHandler);
    ...
    private Float groupVariableHandler(WorkspaceBlock workspaceBlock) {
    ...
    private Boolean isBoolVariableTrueHandler(WorkspaceBlock workspaceBlock) {
        String boolVariableId = workspaceBlock.getFieldId("bool_variables_group");
        WorkspaceBooleanEntity entity = entityContext.getEntity(WorkspaceBooleanEntity.PREFIX + boolVariableId);
        return entity.getValue();
    }

    private Float lastBackupValueEvaluate(WorkspaceBlock workspaceBlock) {
